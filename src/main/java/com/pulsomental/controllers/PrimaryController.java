...
public class PrimaryController {
    ...
    public void initialize() {
        try {
            ...
            simulateOver.setOnAction(event -> gameOver());
    ...
    private void gameOver() {
        {
            ...
            characterImg.setScaleX(0.5);
            characterImg.setScaleY(0.5);
            hiddeAllCircles();
            primaryService.simulateOver(contentGame);
    ...
    private void reset() {
        ...
        character.setX(0);
        character.setY(0);
        characterImg.setScaleX(1);
        characterImg.setScaleY(1);
        showAllCircles();

        modeTitle.setText("Modo Memoria");
    }

    public void hiddeAllCircles() {
        for (Node node : contentGame.getChildren()) {
